...
import { IOrder, IPCartProduct, ShippingAddress } from '../../interfaces';
...
export const CartProvider: FC<PropsWithChildren<Props>> = ({children}) => {
  ...
  useEffect(() => {
    try {
      ...
      console.error('[useEffect] error al cargar las cookies del cart');
  ...
  const addProductToCart = (product: IPCartProduct) => {
  ...
  const updateCartQuantity = (product: IPCartProduct) => {
    dispatch({ type: '[Cart] - Change cart quantity', payload: product });
  }

  const removeCartProduct = (product: IPCartProduct) => {
