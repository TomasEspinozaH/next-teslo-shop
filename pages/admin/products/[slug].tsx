...
const ProductAdminPage:FC<Props> = ({ product }) => {
  ...
  const fileInpuutRef = useRef<HTMLInputElement>(null);
        ...
        <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={ 6 }>
              <TextField
                ...
                { ...register('slug', {
                  required: 'Este campo es requerido',
                  validate: ( value ) => value.trim().includes(' ') ? 'No puede tener espacio en blancos' : undefined
                })}
                error={ !!errors.slug }
            ...
            />
              ...
              <Box display='flex' flexDirection="column">
                ...
                <Button
                  ...
                  sx={{ mb: 3 }}
                  onClick={ () =>  fileInpuutRef.current?.click() }
                >
                  Cargar imagen
                </Button>
                <input 
